...
!!! tip "Werkt niet bij het TechLab"
    ...
    Ik heb een speciale versie van de software op de computer gezet. Deze software heet "Desktop". Hiermee kun je de wifi instellen met de juiste naam en wachtwoord. Het wifi netwerk staat al ingesteld voor je.
