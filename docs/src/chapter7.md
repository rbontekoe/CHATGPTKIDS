...
Vervang de Python code van vuurpijl.py door de code die staat aan het begin van deze paragraaf, [Stap 2](../chapter7/index.html#Stap-2:-Vervang-de-Python-code-door-die-van-de-docent.). Test de code.
